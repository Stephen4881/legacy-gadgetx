    ...
    <section className="py-24 bg-zinc-950 text-white relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-16 text-center">
          <a href="https://wa.me/2347032220586" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-full font-bold hover:opacity-90 transition-opacity">
            Book a Repair Now
          </a>
        </div>
      </div>
